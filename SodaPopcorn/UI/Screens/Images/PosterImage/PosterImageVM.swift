...
public protocol PosterImageVMInputs: AnyObject {
...
public protocol PosterImageVMOutputs: AnyObject {
...
public protocol PosterImageVMTypes: AnyObject {
    var inputs: PosterImageVMInputs { get }
    var outputs: PosterImageVMOutputs { get }
}

public final class PosterImageVM: ObservableObject, Identifiable, PosterImageVMInputs, PosterImageVMOutputs, PosterImageVMTypes {
    // MARK: Constants
    let imageURL: String

    // MARK: Variables
    public var inputs: PosterImageVMInputs { return self }
    public var outputs: PosterImageVMOutputs { return self }
