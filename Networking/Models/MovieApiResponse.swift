...
public struct MovieApiResponse: Decodable {
    ...
    public let id, movieTitle, overview, posterPath, backdropPath, releaseDate, homepage, tagline, character: String?
    ...
    public init(from decoder: Decoder) throws {
        ...
        movieTitle = try container.decodeIfPresent(String.self, forKey: .title)
